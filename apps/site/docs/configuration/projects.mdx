...
| **Emoji icon** | Its face — on the Projects page, the chat hero, and the conversations list |
...
- The **conversations sheet** in a project chat — behind the leading glass disc since **v1.0.267** — shows **only that project's conversations**, under the project's name.
- Conversation chips and **History** rows wear the project's emoji.
