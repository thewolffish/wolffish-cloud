...
<Tabs>
  ...
  <Tab title="Step 2: Configure Wolffish">
    In Wolffish, open **Settings → Channels → Telegram** and paste your bot token. Click **Connect**.
...
| Command | Action |
|---|---|
| `/stop` | Stop the task running in this chat. Anything queued still runs after it — the reply tells you how many messages are waiting. |
...
**Enable it:** Settings → Preferences → Block sensitive data in messages
