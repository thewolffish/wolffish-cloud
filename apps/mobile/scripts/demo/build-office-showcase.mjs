...
/**
 * Hours above conv-file-showcase, matching wolffish-mobile so the two datasets
 * keep the same relative order. This repo carries no code showcase above them,
 * so here they are the demo's opening pair — which is the point: the office
 * cards are the newest thing the feed can do.
 */
