...
export function WaitCard({
  ...
  const send = async (): Promise<void> => {
    ...
    try {
      ...
      // echoes back, so clearing the draft would delete what they typed with
      // nothing to show for it. Keep it, exactly as a failed post does.
