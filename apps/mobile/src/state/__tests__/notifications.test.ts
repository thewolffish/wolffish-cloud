...
describe('the count a conversation wears', () => {
  ...
  it('keeps conversations apart', () => {
    deliver('n1')
    deliver('n2', { conversationId: 'conv-b', deeplink: 'wolffishcloud://chat?id=conv-b' })
...
describe('the icon and the sheet', () => {
  it('keeps a general notification off the icon but on the page', () => {
    ...
    deliver('n1', {
      conversationId: null,
      deeplink: 'wolffishcloud://settings/model',
      counted: true
    })
...
describe('answering one', () => {
  ...
  it('opening the conversation answers all of its notifications at once', () => {
    deliver('n1')
    deliver('n2')
    deliver('other', { conversationId: 'conv-b', deeplink: 'wolffishcloud://chat?id=conv-b' })
