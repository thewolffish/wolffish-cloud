...
export const CLI_SETTINGS: CliSetting[] = [
  ...
  // ── Channels ─────────────────────────────────────────────────────────────
  {
    ...
    description:
      'On adds every tool call and its result to the chat, plus the model chip. Off shows only what always appears: replies, delivered files, questions and approvals, and reasoning.',
    kind: 'boolean',
