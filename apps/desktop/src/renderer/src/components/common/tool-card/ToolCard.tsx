...
import type { Segment, ToolResultMeta, ToolResultStatus } from '@preload/index'
...
export function ToolCard({
  ...
  return (
    <div
      className={cn(
        'group border-border bg-surface w-full max-w-[85%] self-start rounded-2xl border text-sm',
