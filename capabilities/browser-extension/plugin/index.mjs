...
const toolDefinitions = [
  ...
  {"name": "ext_tabs_list", "description": "List all open tabs with id, url, title, active state, and a wolffish flag that is true for tabs in the Wolffish tab group and false for the user's own tabs.", "parameters": {"type": "object", "properties": {"windowId": {"type": "number", "description": "Filter to a specific window. Default all windows."}}, "required": []}},
