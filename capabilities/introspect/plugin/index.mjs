...
const toolDefinitions = [
  ...
  },
  {
    ...
    description:
      "List files inside the Wolffish workspace ONLY (~/.wfc/workspace — your own memory, generated files, capabilities, logs) as a structured tree with sizes. NOT a general file browser: it refuses paths outside the workspace. For the user's files anywhere else (Desktop, Documents, projects, any absolute path), use the filesystem tools or shell instead.",
    parameters: {
      type: 'object',
      properties: {
        dir: {
